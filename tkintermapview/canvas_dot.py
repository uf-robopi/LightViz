...
class CanvasDot:
    def __init__(self,
        ...
        # 加載 PNG 圖片
        self.photo_image1 = PhotoImage(file='tkintermapview/red_circle_50.png')
        self.photo_image2 = PhotoImage(file='tkintermapview/red_circle_70.png')
        self.photo_image3 = PhotoImage(file='tkintermapview/red_circle_90.png')
        self.photo_image4 = PhotoImage(file='tkintermapview/red_circle_110.png')
        self.photo_image5 = PhotoImage(file='tkintermapview/red_circle_130.png')
        self.photo_image6 = PhotoImage(file='tkintermapview/red_circle_150.png')
        self.photo_image7 = PhotoImage(file='tkintermapview/red_circle_170.png')
        self.photo_image8 = PhotoImage(file='tkintermapview/red_circle_190.png')
        self.photo_image9 = PhotoImage(file='tkintermapview/red_circle_210.png')
        self.photo_image10 = PhotoImage(file='tkintermapview/red_circle_230.png')
        self.photo_legend = PhotoImage(file='tkintermapview/custom_colorbar.png')
            ...
            if 0 - 50 < canvas_pos_x < self.map_widget.width + 50 and 0 < canvas_pos_y < self.map_widget.height + 70:
                ...
                # 如果沒有指定圖標，則繪製標準的標記形狀
                    ...
                    if self.big_circle is None:
                        ...
                        interval = self.find_interval(self.val)
                        if interval == 10:
                            ...
                            image = self.photo_image4
                        elif interval == 6:
                            image = self.photo_image5
                        elif interval == 5:
                            image = self.photo_image6
                        elif interval == 4:
                            image = self.photo_image7
                        elif interval == 3:
                            image = self.photo_image8
                        elif interval == 2:
                            image = self.photo_image9
                        elif interval == 1:
                            image = self.photo_image10
                        else:
                            image = self.photo_image10

                        if self.first == False:
                           self.big_circle = self.map_widget.canvas.create_image(520, 150,
                                                                            anchor=self.icon_anchor,
                                                                            image=self.photo_legend,
                                                                            tag="marker") 
                           self.first == True
                        ...
                        self.map_widget.canvas.coords(self.big_circle, canvas_pos_x, canvas_pos_y)
